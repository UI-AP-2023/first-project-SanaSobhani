...
import com.example.phase2.model.commodity.CommodityScore;
...
import com.example.phase2.model.user.CustomerRequest;
import com.example.phase2.model.user.RequestType;
...
public class CustomerController {
    ...
    public boolean signUp(String userName, String passWord, String phoneNumber, String eMail) throws InvalidInput {
    ...
    public boolean editPassWord(String newPassWord) throws InvalidPassword {
        for (int i = 0; i < customers.size(); i++) {
    ...
    public boolean editPhoneNumber(String newPhoneNumber) throws InvalidPhoneNumber {
        for (int i = 0; i < customers.size(); i++) {
    ...
    public boolean editEmail(String newEmail) throws InvalidEmail {
        for (int i = 0; i < customers.size(); i++) {
    ...
    public boolean buy(String discountCode) throws WrongDiscount, NoInventory, InsufficientCredit {
        int cost =0;
        ...
        {
            if(commodity.getAmountOfInventory()==0)
            {
    ...
    public boolean buy() throws WrongDiscount, NoInventory, InsufficientCredit {
        return buy(null);
    }
